...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered mental wellness support for Pakistani youth. Aligned with SDG 3, Vision 2030 & 2035." },
      { property: "og:title", content: "MindCare Pakistan — Your Mental Wellness Companion" },
      { property: "og:description", content: "AI-powered mental wellness support for Pakistani youth. Aligned with SDG 3, Vision 2030 & 2035." },
